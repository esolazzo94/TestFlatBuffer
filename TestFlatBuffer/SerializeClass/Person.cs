...
public struct Person : IFlatbufferObject
{
  ...
  public Work? Works(int j) { int o = __p.__offset(8); return o != 0 ? (Work?)(new Work()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int WorksLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
  public Work? WorksByKey(string key) { int o = __p.__offset(8); return o != 0 ? Work.__lookup_by_key(__p.__vector(o), key, __p.bb) : null; }
  public NickName? NickNames(int j) { int o = __p.__offset(10); return o != 0 ? (NickName?)(new NickName()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int NickNamesLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
  public NickName? NickNamesByKey(string key) { int o = __p.__offset(10); return o != 0 ? NickName.__lookup_by_key(__p.__vector(o), key, __p.bb) : null; }

  public static Offset<Person> CreatePerson(FlatBufferBuilder builder,
      StringOffset nameOffset = default(StringOffset),
      VectorOffset parentOffset = default(VectorOffset),
      VectorOffset worksOffset = default(VectorOffset),
      VectorOffset nickNamesOffset = default(VectorOffset)) {
    builder.StartObject(4);
    Person.AddNickNames(builder, nickNamesOffset);
  ...
  public static void AddWorks(FlatBufferBuilder builder, VectorOffset worksOffset) { builder.AddOffset(2, worksOffset.Value, 0); }
  public static VectorOffset CreateWorksVector(FlatBufferBuilder builder, Offset<Work>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateWorksVectorBlock(FlatBufferBuilder builder, Offset<Work>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartWorksVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddNickNames(FlatBufferBuilder builder, VectorOffset nickNamesOffset) { builder.AddOffset(3, nickNamesOffset.Value, 0); }
  public static VectorOffset CreateNickNamesVector(FlatBufferBuilder builder, Offset<NickName>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateNickNamesVectorBlock(FlatBufferBuilder builder, Offset<NickName>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
